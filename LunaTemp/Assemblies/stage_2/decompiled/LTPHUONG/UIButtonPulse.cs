...
namespace LTPHUONG
{
	public class UIButtonPulse : MonoBehaviour
	{
		...
		[SerializeField]
		private Vector2 landscapeImagePos;

		[SerializeField]
		private Vector2 landscapeButtonPos;
		...
		public void Show()
		{
			...
			pulseTween?.Kill();
			pulseTween = rt.DOScale(scaleMax, pulseDuration).SetEase(Ease.InOutSine).SetLoops(-1, LoopType.Yoyo);
		}
